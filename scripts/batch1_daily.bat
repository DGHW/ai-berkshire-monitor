@echo off
REM ============================================================
REM  买卖闭环定时任务 — 每日 batch1（价格扫描 + 持仓巡检）
REM  Windows 计划任务：schtasks /create /tn "StockMonitorDaily" /tr "cmd /c C:\Users\17356\WorkBuddy\2026-08-07-20-15-31\ai-berkshire\scripts\batch1_daily.bat" /sc daily /st 15:05
REM ============================================================
